...
public class LoginActivity extends AppCompatActivity  {
    ...
    String TAG="LoginData";
    UserData userDataOfThisAccount;
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            Call<UserData> call = apiInterface.getUserbyEmailAPassword(email,password);
            ...
            call.enqueue(new Callback<UserData>() {
                ...
                public void onResponse(Call<UserData> call, Response<UserData> response) {
                    ...
                    if(response.code()==201) {
                        ...
                        userDataOfThisAccount = response.body();
                        showProgress(false);

                        Log.v(TAG,"User: "+userDataOfThisAccount.fullName);
                        Tools.SetUsetDataOfThisAccount(LoginActivity.this,email,password);
                        Tools.thisUserAccount=userDataOfThisAccount;
                        finish();
                    }else{
                        Log.v(TAG,"wrong data");
                        showProgress(false);
